...
welcome to your quickstart guide! here, we'll guide you through creating an account in our web app, generating your first API key, and making your initial request using the `/lipsync` endpoint.
