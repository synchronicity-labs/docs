---
title: 'introduction'
description: 'learn how to use the sync. apis to modify + synthesize humans in video'
---
...
all sync. api endpoints expect an `x-api-key` header in every request. 
...
checkout the [quickstart quide](https://docs.synclabs.so//api-reference/quickstart) to learn how to get your api key and start making requests today.
