...
yargs(hideBin(process.argv))
    .command('page [url]', 'Scrapes a page', () => { }, async (argv) => {
    await scrapePageAutomatically(argv);
})
    .command('gitbook-page [url]', 'Scrapes a GitBook page', () => { }, async (argv) => {
    await scrapePageWrapper(argv, scrapeGitBookPage);
})
    .command('readme-page [url]', 'Scrapes a ReadMe page', () => { }, async (argv) => {
    await scrapePageWrapper(argv, scrapeReadMePage);
})
    .command('intercom-page [url]', 'Scrapes a Intercom page', () => { }, async (argv) => {
    await scrapePageWrapper(argv, scrapeIntercomPage);
})
    .command('section [url]', 'Scrapes the docs in the section', () => { }, async (argv) => {
    await scrapeSectionAutomatically(argv);
})
    .command('gitbook-section [url]', 'Scrapes the Gitbook section', () => { }, async (argv) => {
    await scrapeGitbookSectionCommand(argv);
})
    .command('readme-section [url]', 'Scrapes the ReadMe section', () => { }, async (argv) => {
    await scrapeSectionAxiosWrapper(argv, scrapeReadMeSection);
})
    .command('intercom-section [url]', 'Scrapes the Intercom section', () => { }, async (argv) => {
